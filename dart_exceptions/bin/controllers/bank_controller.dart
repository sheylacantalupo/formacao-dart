...
class BankController {
  ...
  bool makeTransfer(
    ...
    // Adicionando a verificação - se o destinatário está autenticado
    ...
    if (accountSender.balance < amount) {
      throw SenderBalancerLowerThanAmountException(idSender: idSender, senderBalance: accountSender.balance, amount: amount);
    }
